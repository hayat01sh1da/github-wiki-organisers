...
require_relative '../lib/github_wiki_organiser/unknown_wiki_list_exporter_for_llm'

class UnknownWikiListExporterForLLMTest < ApplicationTest
  def setup(group_by: 'Owner', language: 'English')
    super
    GithubWikiOrganiser::UnknownWikiListExporterForLLM.run(base_path:, group_by:, language:)
